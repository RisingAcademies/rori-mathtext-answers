...
from mathtext_fastapi.formaters import format_single_event_nlu_response
...
ERROR_RESPONSE_DICT = format_single_event_nlu_response(
    'error',
    TOKENS2INT_ERROR_INT,
    0
)
TIMEOUT_RESPONSE_DICT = format_single_event_nlu_response(
    'timeout',
    TOKENS2INT_ERROR_INT,
    0
)